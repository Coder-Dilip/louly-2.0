...
function Whyus() {
    ...
    return (
        <div style={{marginLeft: width > 542 ? '10%' : '6%',maxWidth:'80%',display:'flex',flexWrap:'wrap',alignItems:'center',justifyContent:'space-evenly',marginBottom:'80px'}}>
            ...
            <div className={styles.right_whyus}  style={{maxWidth:'40%',minWidth:'230px',marginLeft:'30px'}}>
                ...
                <p style={{fontSize:'1.2rem',lineHeight:'1.8rem'}}>Easy to search for best Hotels and Popular places of Nepal for your best Travelling experience. Huge community with more than 1M+ reach every month. 200+ places for travelling with 500+ Hotels.</p>
